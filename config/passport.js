      ...
      errors.forEach((errs)=>{
         error1.push(errs.msg);
           ...
           User.findOne({"local.email":email},(err,existingUser)=>{
              ...
              if(existingUser) return done(null,false,req.flash("error","That email is already taken."));
              if(errors) return done(null,false,req.flash("error_msg",error1));
                    ...
                    newUser.local.image        = "https://res.cloudinary.com/dlvavuuqe/image/upload/v1493481596/user2_ibfr6d.png";
